...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm">
                    <form class="w-100" method="post" action="{{route('admin.post.update',['post' => $post->id])}}"
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" id="main_title_az" name="main_title:az"
                                           value="{{ $post->translate('az')->main_title }}">
                                </div>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" id="main_title_en" name="main_title:en"
                                     value="{{ $post->translate('en')->main_title }}">
                                </div>
                                <div class="form-group">
